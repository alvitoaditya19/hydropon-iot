...
export default function SummaryCard({title, total}) {
  return (
    <>
      <div className="col-lg-4 pb-lg-0 pb-4">
        <div className="summary-card">
          <div className="d-flex align-items-center mb-24">
            ...
            <p className="summary-title mb-0 ms-12">
              Amount Of
              <br /> {title}
            </p>
          </div>
          <div>
            <p className="text-sm summary-total mb-1">Total</p>
            <p className="summary-total-title fw-medium m-0">{total}</p>
          </div>
        </div>
      </div>
    </>
